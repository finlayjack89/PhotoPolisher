...
- **User-Controlled Positioning**: Complete removal of automatic padding manipulation - subjects display at original size (scale=1.0) with user-controlled positioning only via placement.x, placement.y, and placement.scale parameters.
